...
//    }
    ...
    @When("I click on different phone {string} with external data")
    public void i_click_on_different_phone_with_external_data(String phone) throws InterruptedException {
        storeHomePage.clickOnDifferentPhone(ApplicationHooks.map.get(phone));
    }
